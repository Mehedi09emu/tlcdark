...
----------------------------------------------------------------
MADE BY TEAM ARAFAT
TELEGRAM : https://t.me/cybararmy
GITHUB       : Mehedi09emu
FACEBOOK  : TEAM TLC DARK TEAM
WEB : no fund
---------------------------------------------------------------
---------------------------------------------------------------- ''')
...
def setup ():
	...
	exit()
def bkbomb():
	os.system("rm -rf BKASH_BOMBER && git clone https://github.com/teamARAFATbruh/BKASH_BOMBER && cd BKASH_BOMBER && python ARAFATbkash.py")
def zphisher ():
...
def join():
	os.system("xdg-open https://t.me?cybararmy")
def main():
	os.system('clear')
	print(logo)
	print('')
	print(menu)
	option = input(f'{GREEN}Choose Option : ')
	if option == '1':
		setup()
		main()
	elif option == '2':
	  ...
	  zphisher()
		...
		print("OPTION NOT FOUND")
		print("OPTION NOT FOUND")
		print("DEVELOPED BY TEAM ARAFAT")
		time.sleep(3)
		main()
